...
const HeroHoverButton = ({ className, text }) => {
  return (
    <div
      className={`flex text-lg sm:text-3xl gap-5 items-center text-center px-[41.5px] py-[19.5px] rounded sm:my-[42px] my-[10px] group ${className}`}
    >
      <button className="text-center w-full">{text}</button>
      <Image
        src={Img}
        alt="Went to Link"
        width={20}
