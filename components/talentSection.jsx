...
//   return (
//     <section className=" bg-[#0A0F1F] text-white py-16 px-20 ">
//       <div className="flex gap-[204px] py-[70px] ">
...
//       <div className="flex gap-8 pt-6 border-t-[1px] border-[lightgray] ">
//         <div className="flex items-center gap-2">
//           <Image src={ticked} alt={ticked} />
...
//         <div className="flex items-center gap-2">
//           <Image src={ticked} alt={ticked} />
//           <p className="text-xs md:text-sm text-gray-300">Zero Hidden Fees</p>
//         </div>
//       </div>
//     </section>
//   );
